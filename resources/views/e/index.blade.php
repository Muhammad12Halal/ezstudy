						...
						<div class="row">
							<div class="col-md-4 col-sm-6">
								<div class="cours-search-bx m-b30">
									<div class="icon-box">
										<h3><i class="ti-user"></i><span class="counter">
                                            @php
                                                $count = App\Models\User::where('level', 'User')->count();
                                                echo $count;
                                            @endphp
                                        </span></h3>
									</div>
									<span class="cours-search-text">Over @php
                                        $count = App\Models\User::where('level', 'User')->count();
                                        echo $count;
                                    @endphp student</span>
								</div>
							...
							<div class="col-md-4 col-sm-6">
								<div class="cours-search-bx m-b30">
									<div class="icon-box">
										<h3><i class="ti-book"></i><span class="counter">
                                            @php
                                                $count = App\Models\Course::where('status', 'Active')->count();
                                                echo $count;
                                            @endphp
                                        </span></h3>
									</div>
									<span class="cours-search-text">@php
                                        $count = App\Models\Course::where('status', 'Active')->count();
                                        echo $count;
                                    @endphp
                                    Courses.</span>
							...
							<div class="col-md-4 col-sm-12">
								<div class="cours-search-bx m-b30">
									<div class="icon-box">
										<h3><i class="ti-layout-list-post"></i><span class="counter">@php
                                            $count = App\Models\CourseContent::count();
                                            echo $count;
                                        @endphp
			...
			<div class="section-area section-sp2">
				<div class="container">
					...
					<div class="text-center">
						<a href="{{ route('e.event') }}" class="btn">View All Event</a>
					</div>
				</div>
			</div>
                        ...
                        <div class="item">
							<div class="testimonial-bx">
								<div class="testimonial-thumb">
									<img src="{{ asset('profile/'.$rating->user->profiles->image) }}" alt="">
								</div>
								<div class="testimonial-info">
									<h5 class="name">{{ $rating->user->name }}</h5>
									<p>-{{ $rating->user->level }}</p>
								</div>
