                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="mt-3">
                            ...
                            @endif
                            <form action="{{ route('admin.enroll.update', $enroll->id) }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                <div class="form-group row">
                                    ...
                                    <div class="col-8">
                                        ...
                                        @forelse ($users as $user)
                                            <option value="{{ $user->id }}" {{ $user->id == $enroll->user_id ? 'selected' : '' }}>{{ $user->name }}</option>
                                        @empty
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-8">
                                        ...
                                        @forelse ($courses as $course)
                                            <option value="{{ $course->id }}" {{ $course->id == $enroll->course_id ? 'selected' : '' }}>{{ $course->title }}</option>
                                        @empty
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-8">
                                        ...
                                        <option value="">Select</option>
                                        <option value="Completed" {{ $enroll->status == 'Completed' ? 'selected' : '' }}>Completed</option>
                                        <option value="Not Completed" {{ $enroll->status == 'Not Completed' ? 'selected' : '' }}>Not Completed</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="form-group row">
