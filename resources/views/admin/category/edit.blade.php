                        ...
                        <div class="mt-3">
                            ...
                            <form action="{{ route('admin.category.update', $category->id) }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-group row">
                                  ...
                                  <div class="col-8">
                                    <input id="name" name="name" type="text" class="form-control" value="{{ $category->name }}" required="required">
                                  </div>
                                </div>
                                <div class="form-group row">
                                    <label for="image" class="col-4 col-form-label">Image</label>
                                    <div class="col-8">
                                      <img src="{{ asset('images/'.$category->image) }}" class="img-thumbnail" alt="{{ $category->slug }}" width="200px" height="200px">
                                      <br><br>
