                        ...
                        <div class="mt-3">
                            ...
                            <form action="{{ route('admin.event.update', $event->id) }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-group row">
                                  ...
                                  <div class="col-8">
                                    <input id="title" name="title" type="text" class="form-control" value="{{ $event->title }}" required="required">
                                  </div>
                                </div>
                                <div class="form-group row">
                                    <label for="image" class="col-4 col-form-label">Image</label>
                                    <div class="col-8">
                                      <img id="image" src="{{ asset('event/'. $event->image) }}" alt="" class="img-thumbnail" style="width: 100px; height: 100px;">
                                      <br><br>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-8">
                                      <input id="location" name="location" type="text" class="form-control" value="{{ $event->location }}" required="required">
                                    </div>
                                </div>
                                <div class="form-group row">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-8">
                                      <input id="time" name="time" type="time" class="form-control" value="{{ $event->time }}" required="required">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="desc" class="col-4 col-form-label">Description</label>
                                    <div class="col-8">
                                      <textarea id="desc" name="desc" type="text" class="form-control" required="required">{{ $event->desc }}</textarea>
                                    </div>
                                </div>
                                <div class="form-group row">
