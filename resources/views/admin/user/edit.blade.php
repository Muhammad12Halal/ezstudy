                        ...
                        <div class="mt-3">
                            ...
                            <form action="{{ route('admin.user.update', $user->id) }}" method="POST">
                                ...
                                <div class="form-group row">
                                  ...
                                  <div class="col-8">
                                    <input id="name" name="name" type="text" class="form-control" value="{{ $user->name }}" required="required">
                                  </div>
                                </div>
                                <div class="form-group row">
                                ...
                                <div class="form-group row">
                                  ...
                                  <div class="col-8">
                                    <select id="level" name="level" class="select2 form-select shadow-none" required="required">
                                      ...
                                      <option value="Instructor" {{ $user->level == 'Instructor' ? 'selected' : '' }} >Instructor</option>
