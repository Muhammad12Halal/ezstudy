                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="mt-3">
                            ...
                            @endif
                            <form action="{{ route('admin.content.update', $courseContent->id) }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-8">
                                        ...
                                        @forelse ($courses as $course)
                                            <option value="{{ $course->id }}" {{ $course->id == $courseContent->course_id ? 'selected' : '' }}>{{ $course->title }}</option>
                                        @empty
